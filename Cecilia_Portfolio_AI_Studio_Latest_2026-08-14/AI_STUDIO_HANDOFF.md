...
- `SkillsSection()` currently uses a centered warm apricot canvas tote. Notebook, laptop, earbuds, and glasses are independent interactive layers physically tucked into the bag and lift only 20–28px on hover/tap.
...
- `assets/skills/ai-earbuds.png`
- `assets/skills/global-glasses.png`
